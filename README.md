...
<script src="https://cdn.jsdelivr.net/npm/particles.js@2.0.0/particles.min.js"></script>
	...
	<body>
  <div id="particles-js"><canvas class="particles-js-canvas-el" width="400" height="833" style="width: 100%; height: 100%;"></canvas></div> <div class="count-particles"> <span class="js-count-particles"></span> </div> <script src="http://cdn.jsdelivr.net/particles.js/2.0.0/particles.min.js"></script><script src="http://threejs.org/examples/js/libs/stats.min.js"></script>
<div class="wrap">
		<div class="widget">
			<div class="fecha">
				<p id="diaSemana" class="diaSemana">Friday</p>
				<p id="dia" class="dia">17</p>
              <p>/</p>
				<p id="mes" class="mes">July</p>
              <p>/</p>
...
<svg>
  ...
  <svg viewBox="0 0 960 300">
	<symbol id="s-text">
          <text text-anchor="start" x="10%" y="98%">Xat.com/</text>
	</symbol>
  ...
  <defs>
    ...
    <linearGradient id="gradient" x1="2" x2="1.73" y1="0.2" y2="0.9">
      <stop offset="50%" stop-color="#ffa800"></stop>
      <stop offset="50" stop-color="#ff6000"></stop>
    </linearGradient>
    <pattern id="wave" x="0" y="4.2" width="120" height="30" patternUnits="userSpaceOnUse">
      <path id="wavePath" d="M-40 9 Q-30 7 -20 9 T0 9 T20 9 T40 9 T60 9 T80 9 T100 9 T120 9 V20 H-40z" mask="url(#mask)" fill="url(#gradient)"> 
        <animateTransform attributeName="transform" begin="0s" dur="8s" type="translate" from="0,4" to="40,4" repeatCount="indefinite"></animateTransform>
      </path>
    </pattern>
  </defs>
