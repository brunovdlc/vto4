...
<div class="wrap">
    <div class="widget">
      <div class="fecha">
        <p id="diaSemana" class="diaSemana">Domingo</p>
        <p id="dia" class="dia">03</p>
              <p>/</p>
        <p id="mes" class="mes">Janeiro</p>
              <p>/</p>
        <p id="year" class="year">2021</p>
      </div>
  
      <div class="reloj">
        <p id="horas" class="horas">5</p>
        <p>:</p>
...
body {
  background:url(https://i.imgur.com/P8Pq0u8.png?1) #000010;
